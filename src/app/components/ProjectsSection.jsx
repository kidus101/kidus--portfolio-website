...
const projectsData = [
  {
    ...
    description:
      "Ride-sharing is a convenient and efficient transportation service that connects passengers with drivers while sharing the ride and the cost.",
  ...
  {
    id: 5,
    title: "HomeSuiteHome ( Furniture Ecommerce Platform)",
    description:
      "Home Suite Home a tailored e-commerce application for homeowners , Business owness and Interior designors where the client can get a wide range of furniture solutions Using the MERN Stack .",
    image: "/images/projects/home-suite-home.png",
    tag: ["All", "FullStack"],
    gitUrl: "/",
    previewUrl: "/",
  },
  ...
  {
    id: 7,
    title: "BlackRock Educational Consultancy Web Application",
